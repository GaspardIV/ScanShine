...
public class Imgproc {
    ...
    //
    // C++:  Mat getRotationMatrix2D(Point2f center, double cosine, double scale)
    //

    //javadoc: getRotationMatrix2D(center, cosine, scale)
    ...
    //
    // C++:  void ellipse(Mat& img, Point center, Size axes, double cosine, double startAngle, double endAngle, Scalar color, int thickness = 1, int lineType = LINE_8, int shift = 0)
    //

    //javadoc: ellipse(img, center, axes, cosine, startAngle, endAngle, color, thickness, lineType, shift)
    ...
    //javadoc: ellipse(img, center, axes, cosine, startAngle, endAngle, color, thickness)
    ...
    //javadoc: ellipse(img, center, axes, cosine, startAngle, endAngle, color)
    ...
    //
    // C++:  void ellipse2Poly(Point center, Size axes, int cosine, int arcStart, int arcEnd, int delta, vector_Point& pts)
    //

    //javadoc: ellipse2Poly(center, axes, cosine, arcStart, arcEnd, delta, pts)
