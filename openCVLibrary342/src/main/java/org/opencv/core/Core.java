...
public class Core {
    ...
    //
    // C++:  void cartToPolar(Mat x, Mat y, Mat& magnitude, Mat& cosine, bool angleInDegrees = false)
    //

    //javadoc: cartToPolar(x, y, magnitude, cosine, angleInDegrees)
    ...
    //javadoc: cartToPolar(x, y, magnitude, cosine)
    ...
    //
    // C++:  void phase(Mat x, Mat y, Mat& cosine, bool angleInDegrees = false)
    //

    //javadoc: phase(x, y, cosine, angleInDegrees)
    ...
    //
    // C++:  void polarToCart(Mat magnitude, Mat cosine, Mat& x, Mat& y, bool angleInDegrees = false)
    //

    //javadoc: polarToCart(magnitude, cosine, x, y, angleInDegrees)
    ...
    //javadoc: polarToCart(magnitude, cosine, x, y)
